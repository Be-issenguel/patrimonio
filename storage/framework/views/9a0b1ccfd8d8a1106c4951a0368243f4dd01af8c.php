                ...
                <tbody>
                    <?php $__currentLoopData = $despesas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $despesa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="gradeX">
                            ...
                            <td><?php echo e(explode('\\', $despesa->despesable_type)[1]); ?> -
                                <?php echo e(explode('\\', $despesa->despesable_type)[1] == 'Poupanca' ? $despesa->despesable->motivo : $despesa->despesable->tipo . ',  ' . $despesa->despesable->mes); ?>
